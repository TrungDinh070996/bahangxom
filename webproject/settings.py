...
SECRET_KEY = 'django-insecure-rh@x0p_d(!+70$daujuek5e6*oqv0-#=e42d-wpom(0id5+)bn'
...
if DATABASE_URL:
    ...
    # fallback dùng SQLite cho local dev
    DATABASES = {
        'default': {
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'app/static/images_url')
